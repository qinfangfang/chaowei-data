      ...
      <div class="all-products">
        <div class="prod-operate">
          ...
          <div class="delete-selected">
            <el-button class="add-buy-car" size="mini" @click="handleEdit()"
              >加入购物车</el-button
            >
            <el-button class="normal-btn" size="mini" @click="handleEdit()">删除所选</el-button>
          </div>
        </div>
        <el-table
          ref="multipleTable"
        ...
        >
          ...
          <el-table-column label="操作" width="200">
            <template slot-scope="scope">
              <div class="moveto-favorites">加入购物车</div>
    ...
    .all-products {
      ...
      .prod-operate {
        ...
        .delete-selected {
          ...
          /deep/ .normal-btn:hover,
          /deep/ .normal-btn:focus {
            color: #606266;
